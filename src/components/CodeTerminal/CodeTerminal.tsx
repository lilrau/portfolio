...
const CodeTerminal: React.FC = () => {
  ...
  const fullCode = React.useMemo(() => [
    ...
    '  company: ["Amazoca by Lugenius", "MoonRock Labs"];',
    ...
    "class TechStack {",
    "  frontend = {",
    '    frameworks: ["React", "Vue.js", "Vite", "Next.js", "TypeScript"],',
    '    styling: ["CSS", "Tailwind"],',
    "  };",
    "",
    "  backend = {",
    '    languages: ["PHP", "Java", "TypeScript"],',
    '    frameworks: ["Express.js", "NestJS", "Laravel"],',
    '    storage: ["PostgreSQL", "MySQL", "Redis", "Vector DBs"]',
    "  };",
    "",
    "  tools = {",
    '    other: ["Docker", "Git", "CI/CD", "Jira", "Render", "Vercel", "Linux"]',
    "  };",
    "",
    "  emerging = {",
    '    ai: ["n8n", "OpenAI API", "Google AI Studio", "Claude", "OpenCode", "Codex", "Cursor"],',
    ...
    "  passionate: true,",
    '  expertise: "AI automation, AI features & agentic workflows",',
    '  certifications: ["Software Analyst and Developer @ UTFPR", "English Certificate C1 Advanced @ EF SET"]',
    "};"
  ], []);
